...
@section('subtitle')
    Buat retur pembelian untuk barang yang dikembalikan.
@endsection

@section('content')
<div class="card">
    <div class="card-body">
        <form method="POST" action="{{ route('purchase-returns.store') }}" x-data="prReturForm()">
            @csrf
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                <div class="lg:col-span-2 space-y-5">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        <div class="form-group">
                            <label class="form-label">PO Terkait (opsional)</label>
                ...
                <div class="space-y-5">
                    ...
                    <div class="flex gap-3 pt-2">
                        ...
                        <a href="{{ route('purchase-returns.index') }}" class="btn-ghost">Batal</a>
                    </div>
                </div>
            </div>
        </form>
