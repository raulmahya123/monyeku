...
<div class="page-header">
    ...
    <h1 class="page-title">Supplier Baru</h1>
</div>
    ...
    <div class="card-body">
        <form method="POST" action="{{ route('suppliers.store') }}">
            ...
            <div class="form-group">
                ...
                <input type="text" name="code" value="{{ old('code') }}" required class="form-input" placeholder="Mis: SUP-001">
                @error('code') <p class="form-error">{{ $message }}</p> @enderror
            </div>

            <div class="form-group">
                <label class="form-label">Nama Supplier</label>
                <input type="text" name="name" value="{{ old('name') }}" required class="form-input" placeholder="Nama supplier">
                @error('name') <p class="form-error">{{ $message }}</p> @enderror
            </div>

            <div class="form-group">
                <label class="form-label">Kontak Person</label>
                <input type="text" name="contact_person" value="{{ old('contact_person') }}" class="form-input" placeholder="Nama kontak person">
                @error('contact_person') <p class="form-error">{{ $message }}</p> @enderror
            </div>

            <div class="form-group">
                <label class="form-label">Telepon</label>
                <input type="text" name="phone" value="{{ old('phone') }}" required class="form-input" placeholder="Nomor telepon">
            ...
            <div class="form-group">
                ...
                <input type="text" name="npwp" value="{{ old('npwp') }}" class="form-input" placeholder="Nomor NPWP">
