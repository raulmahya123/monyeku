            ...
            <form method="POST" action="{{ route('products.store') }}">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="unit" name="unit" class="form-input" value="{{ old('unit') }}" placeholder="pcs, kg, liter">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="barcode" name="barcode" class="form-input" value="{{ old('barcode') }}">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div class="form-group">
                        ...
                        <input type="number" id="purchase_price" name="purchase_price" class="form-input" value="{{ old('purchase_price', 0) }}" min="0">
                        @error('purchase_price') <p class="form-error">{{ $message }}</p> @enderror
                    </div>
                    <div class="form-group">
                        <label for="selling_price" class="form-label">Harga Jual</label>
                        <input type="number" id="selling_price" name="selling_price" class="form-input" value="{{ old('selling_price', 0) }}" min="0">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div class="form-group">
                        ...
                        <input type="number" id="stock_min" name="stock_min" class="form-input" value="{{ old('stock_min', 0) }}" min="0">
                        @error('stock_min') <p class="form-error">{{ $message }}</p> @enderror
                    </div>
                    <div class="form-group">
                        <label for="stock_max" class="form-label">Stok Maksimal</label>
                        <input type="number" id="stock_max" name="stock_max" class="form-input" value="{{ old('stock_max', 0) }}" min="0">
                ...
                <div class="form-group">
                    ...
                    <textarea id="description" name="description" class="form-input" rows="2">{{ old('description') }}</textarea>
