...
<div class="flex items-center gap-3 mb-6">
    ...
    <div>
        <h1 class="text-lg font-semibold text-gray-900">Edit Perusahaan</h1>
        <p class="text-sm text-gray-500">Ubah informasi perusahaan</p>
    </div>
</div>
        ...
        <form method="POST" action="{{ route('companies.update', $company) }}">
            ...
            <div class="mb-5">
                ...
                <textarea name="address" rows="3"
                    class="w-full px-3.5 py-2.5 text-sm border border-gray-300 rounded-lg focus:ring-2 focus:ring-orange-500/20 focus:border-orange-500 outline-none transition-all placeholder:text-gray-400"
                    placeholder="Alamat perusahaan">{{ old('address', $company->address) }}</textarea>
