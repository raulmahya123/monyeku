...
<head>
    ...
    <title>403 | {{ config('app.name', 'MoneyKu') }}</title>
...
<body class="min-h-screen bg-white antialiased flex items-center justify-center px-4">
    <div class="w-full max-w-md text-center">
        ...
        <h1 class="mt-3 text-7xl font-bold text-orange-500 leading-none">403</h1>
        <h2 class="mt-4 text-lg font-semibold text-gray-900">Akses Ditolak</h2>
        <p class="mt-2 text-sm text-gray-500 max-w-xs mx-auto">Anda tidak memiliki izin untuk mengakses halaman ini.</p>
