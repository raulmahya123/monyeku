...
<head>
    ...
    <title>503 | {{ config('app.name', 'MoneyKu') }}</title>
...
<body class="min-h-screen bg-white antialiased flex items-center justify-center px-4">
    <div class="w-full max-w-md text-center">
        ...
        <h1 class="mt-3 text-7xl font-bold text-orange-500 leading-none">503</h1>
        <h2 class="mt-4 text-lg font-semibold text-gray-900">Layanan tidak tersedia</h2>
        <p class="mt-2 text-sm text-gray-500 max-w-xs mx-auto">Sistem sedang dalam pemeliharaan. Silakan coba lagi nanti.</p>
